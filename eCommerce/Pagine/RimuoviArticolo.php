    ...
    <section class="page-section bg-light" id="portfolio">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">eliminando l'oggetto porterai la sua quantita a 0 cosi che non venga più visualizzato agli utenti ma esclusivamente agli admin</h3>
            </div>
            <div class="row">
                <div class="text-center">
