    ...
    <section class="page-section bg-light" id="portfolio">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">MODIFCA</h2>
                <h3 class="section-subheading text-muted">mettendo una quantità > 0 il prodotto tornera' disponibile</h3>
            </div>
            <div class="row">
                <div class="text-center">
                    <form action="Controlli/ChkModQuantita.php" method="POST">
                        <?php
                        echo "<p>Modifica la quantita' dell'articolo: " . $_GET['Articolo'] . "</p>";
                        echo "<input type='hidden' name='articolo' value='".$_GET['Articolo']."' >";
                        echo "<input type='number' name='quantita' >";
                        ?>
