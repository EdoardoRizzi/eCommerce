    ...
    <section class="page-section bg-light" id="portfolio">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">ORDINI</h2>
                <h3 class="section-subheading text-muted">questi sono tutti i tuoi ordini</h3>
            </div>
            <div class="row">
                ...
                $stmt = $conn->prepare("SELECT * 
                                        FROM ordine JOIN carello ON ordine.IdCarello = carello.ID 
                                        WHERE carello.IdUtente = " . $_SESSION['id'] . "");
                ...
                if ($result->num_rows > 0) {
                    ...
                    for ($i = 0; $i < $result->num_rows; $i++) {
                        ...
                        if ($row = $result->fetch_assoc()) {
                            ...
                            echo "</div>";
                            echo "<img class='img-fluid' src='assets/img/logos/shop.jpg'/>";
                            echo "</a>";
                            echo "<div class='portfolio-caption'>";
                            echo "<div class='portfolio-caption-heading'>ordine n " . $row["ID"] . "</div>";
                            echo "<div class='portfolio-caption-subheading text-muted'>" . $row["Prezzo"] . "</div>";
                            echo "<div class='portfolio-caption-subheading text-muted'>" . $row["DataAcquisto"] . "</div>";
                            echo "<div class='portfolio-caption-subheading text-muted'>
                                    <a href=DettagliCarrello.php?idcarello=" . $row["IdCarello"] . ">
